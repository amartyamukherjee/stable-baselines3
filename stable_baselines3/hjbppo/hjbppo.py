...
HJBPPOSelf = TypeVar("HJBPPOSelf", bound="HJBPPO")


class HJBPPO(OnPolicyAlgorithm):
    """
    Hamilton Jacobi Bellman Proximal Policy Optimization algorithm (HJBPPO) (clip version)
    ...
    def __init__(
        ...
        assert hasattr(env, 'dt'), f"Environment is missing a time step size (env.dt). Cannot use HJBPPO."
    ...
    def train(self) -> None:
        ...
        entropy_losses = []
        pg_losses, value_losses, hjb_losses = [], [], []
        clip_fractions = []
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                loss = policy_loss + self.ent_coef * entropy_loss + self.vf_coef * value_loss + self.hjb_coef * hjb_loss
